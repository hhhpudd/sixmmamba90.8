...
class FAFuse_B(nn.Module):
    def __init__(self, num_classes=1, drop_rate=0.2, normal_init=True, pretrained=False, ring_radius=[12,24,48], ring_width=[4,8,16]):
        ...
        # 调整了等比
        self.up_c = FAFusion_block(ch_1=256, ch_2=768, ch_int=256, ch_out=256, drop_rate=drop_rate / 2, scale_size=1, ring_width=ring_width[0], imgsize=24, ring_radius=ring_radius[0]) # 384x384:[24, 48, 96]  352x352:[22,44,88]
        self.up_c_1_1 = FAFusion_block(ch_1=128, ch_2=128, ch_int=128, ch_out=128, drop_rate=drop_rate / 2, scale_size=2, ring_width=ring_width[1], imgsize=48, ring_radius=ring_radius[1])
        self.up_c_1_2 = Up(in_ch1=256, out_ch=128, in_ch2=128, attn=True)
        self.up_c_2_1 = FAFusion_block(ch_1=64, ch_2=64, ch_int=64, ch_out=64, drop_rate=drop_rate / 2, scale_size=4, ring_width=ring_width[2], imgsize=96, ring_radius=ring_radius[2])
